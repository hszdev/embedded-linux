...
save_motion_photo() {
    ...
    if [ -n "$image_path" ]; then
        ...
        echo "Saved motion detected image: $destination_dir/$folder_name/$filename"
    fi
}
...
usage() {
    ...
    echo "  photo_cooldown (optional): Cooldown between each photo capture in seconds (default: 3)"
    ...
    echo "  motion_detect_script (optional): Location of the motion detection Python script (default: /home/emli/embedded-linux/wildlife/motion_detect.py)"
}
