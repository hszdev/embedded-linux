...
main() {
    ...
    case "$action" in
        up)
            "$repo_dir/wildlife/bin/save_log.sh" "/home/emli/embedded-linux/wildlife/logs" "Setting up wildlife project"
            setup_cronjobs "$repo_dir"
            setup_services "$repo_dir"
            ;;
        down)
            "$repo_dir/wildlife/bin/save_log.sh" "/home/emli/embedded-linux/wildlife/logs" "Removing wildlife project"
